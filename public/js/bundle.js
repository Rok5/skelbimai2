        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Sėkmingai prisijungta");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            //reload page
            if (res.data.status = "success") window.location.replace("http://127.0.0.1:8000/");
            _context2.next = 11;
            break;
          ...
          case 7:
            ...
            (0, _alert.showAlert)("error", "Klaida atsijungiant, bandykite dar");
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            res = _context3.sent;
            if (res.data.status = "success") (0, _alert.showAlert)("", "Laiškas išsiųstas į elektroninį paštą");
            _context3.next = 10;
            break;
...
var resetPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(password, passwordConfirm, currentURLApi) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Slaptažodis atkurtas");
              window.setTimeout(function () {
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password, passwordConfirm, role, name) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
exports.userSettings = exports.updatePassword = void 0;
...
var userSettings = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Atnaujinta");
              window.setTimeout(function () {
                location.assign("/me");
              }, 1500);
            }
  ...
  return function userSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"sukurtiSkelbima.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sukurtiSkelbima = exports.istrintiSkelbima = void 0;
...
var sukurtiSkelbima = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(pareiguPavadinimas, imonesPavadinimas, atlyginimas, miestas, darboSritis, reikalavimaiDarbuotojui, imoneSiulo, informacijaApieImone, darboPobudis, atlyginimoTipas) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                pareiguPavadinimas: pareiguPavadinimas,
                imone: imonesPavadinimas,
                atlyginimas: atlyginimas,
                miestas: miestas,
                darboSritis: darboSritis,
                reikalavimaiDarbuotojui: reikalavimaiDarbuotojui,
                imoneSiulo: imoneSiulo,
                informacijaApieImone: informacijaApieImone,
                darboPobudis: darboPobudis,
                atlyginimoTipas: atlyginimoTipas
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Skelbimas sukurtas");
            }
  ...
  return function sukurtiSkelbima(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10) {
    return _ref.apply(this, arguments);
  };
}();

exports.sukurtiSkelbima = sukurtiSkelbima;

var istrintiSkelbima = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(skelbimoId) {
    var regex, skelbimoIdIString, regexDone, res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            regex = /(?<=\>).+?(?=\<)/gm;
            skelbimoIdIString = skelbimoId.outerHTML;
            regexDone = regex.exec(skelbimoIdIString);
            console.log(regexDone[0], "regex Done");
            _context2.next = 7;
            return (0, _axios.default)({
              method: "DELETE",
              url: "http://127.0.0.1:8000/api/v1/skelbimai/".concat(regexDone),
              data: {}
            });
          ...
          case 7:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Skelbimas ištrintas");
            }
  ...
  return function istrintiSkelbima(_x11) {
    return _ref2.apply(this, arguments);
  };
}();

exports.istrintiSkelbima = istrintiSkelbima;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"imonesInfo.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateImonesInfo = exports.rodytiImonesInfo = exports.imonesInfo = void 0;
...
var imonesInfo = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(imonesPav, imonesKodas, kontaktinisAsmuo) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                ...
                kontaktinisAsmuo: kontaktinisAsmuo
              }
            });
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Įmonės informacija pridėta");
            }
  ...
  return function imonesInfo(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.imonesInfo = imonesInfo;

var updateImonesInfo = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(imonesPav, imonesKodas, kontaktinisAsmuo) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alert.showAlert)("success", "Įmonės info pridėta");
            }
  ...
  return function updateImonesInfo(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateImonesInfo = updateImonesInfo;

var rodytiImonesInfo = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(imonesPav, imonesKodas, kontaktinisAsmuo) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
  ...
  return function rodytiImonesInfo(_x7, _x8, _x9) {
    return _ref3.apply(this, arguments);
  };
}();

exports.rodytiImonesInfo = rodytiImonesInfo;
...
var _sukurtiSkelbima = require("./sukurtiSkelbima");

var _imonesInfo = require("./imonesInfo");
...
var userUpdateNameEmail = document.querySelector(".form-user-data");
var updatePasswordForm = document.querySelector(".form-user-settings");
var sukurtiSkelbimaForma = document.querySelector(".skelbimoKurimoForma");
var sukurtiImonesInfoForma = document.querySelector(".imonesInfoForma");
var updateImonesInfoForma = document.querySelector(".imonesInfoFormaUpdate");
var trintiSkelbima = document.querySelector(".trintiSkelbima");
...
if (resetPasswordForm) resetPasswordForm.addEventListener("submit", function (e) {
  ...
  var currentURLApi = currentURL.replace("http://127.0.0.1:8000/resetPassword/", "http://127.0.0.1:8000/api/v1/users/resetPassword/");
  console.log(currentURLApi);
  (0, _login.resetPassword)(password, passwordConfirm, currentURLApi);
});
if (trintiSkelbima) trintiSkelbima.addEventListener("click", function (e) {
  e.preventDefault();
  var skelbimoId = document.getElementById("skelbimas");
  console.log(skelbimoId, "is index.js");
  (0, _sukurtiSkelbima.istrintiSkelbima)(skelbimoId);
});
...
if (signUpForm) signUpForm.addEventListener("submit", function (e) {
  ...
  var passwordConfirm = document.getElementById("repass").value;
  var role = document.getElementById("role").value;
  (0, _signup.signup)(email, password, passwordConfirm, role, name);
});
if (userUpdateNameEmail) userUpdateNameEmail.addEventListener("submit", function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value;
  var name = document.getElementById("name").value;
  (0, _userSettings.userSettings)(email, name);
});
if (updatePasswordForm) updatePasswordForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var password, passwordConfirm, currentPassword;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return (0, _userSettings.updatePassword)(currentPassword, password, passwordConfirm);
